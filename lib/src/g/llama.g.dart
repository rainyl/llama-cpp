...
@ffi.DefaultAsset('package:llama_cpp/llama_cpp.dart')
library;
...
external int _llama_pooling_type(
  ffi.Pointer<llama_context> ctx,
);

PoolingType llama_pooling_type(
  ffi.Pointer<llama_context> ctx,
) =>
    PoolingType.fromValue(_llama_pooling_type(
      ctx,
    ));
...
RopeType llama_model_rope_type(
  ffi.Pointer<llama_model> model,
) =>
    RopeType.fromValue(_llama_model_rope_type(
      model,
    ));
...
external int _llama_vocab_type(
  ffi.Pointer<llama_vocab> vocab,
);

VocabType llama_vocab_type(
  ffi.Pointer<llama_vocab> vocab,
) =>
    VocabType.fromValue(_llama_vocab_type(
      vocab,
    ));
...
@ffi.Native<
    ffi.Int32 Function(ffi.Pointer<llama_context>, ffi.Pointer<ffi.Float>,
        ffi.Size, ffi.Int32, ffi.Int32, ffi.Int32)>(isLeaf: true)
...
@ffi.Native<
    ffi.Bool Function(ffi.Pointer<llama_context>, ffi.Pointer<ffi.Char>,
        ffi.Pointer<llama_token>, ffi.Size)>(isLeaf: true)
...
@ffi.Native<
    ffi.Size Function(ffi.Pointer<llama_context>, ffi.Pointer<ffi.Uint8>,
        ffi.Size, llama_seq_id)>(isLeaf: true)
...
@ffi.Native<
    ffi.Size Function(ffi.Pointer<llama_context>, ffi.Pointer<ffi.Char>,
        llama_seq_id, ffi.Pointer<llama_token>, ffi.Size)>(isLeaf: true)
...
TokenAttr llama_vocab_get_attr(
  ffi.Pointer<llama_vocab> vocab,
  Dartllama_token token,
) =>
    TokenAttr.fromValue(_llama_vocab_get_attr(
      vocab,
      token,
    ));
...
class _SymbolAddresses {
  ...
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function()>> get llama_backend_free =>
      ffi.Native.addressOf(self.llama_backend_free);
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<llama_model>)>>
      get llama_model_free => ffi.Native.addressOf(self.llama_model_free);
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<llama_context>)>>
      get llama_free => ffi.Native.addressOf(self.llama_free);
  ffi.Pointer<
          ffi
          .NativeFunction<ffi.Void Function(ffi.Pointer<llama_adapter_lora>)>>
      get llama_adapter_lora_free =>
          ffi.Native.addressOf(self.llama_adapter_lora_free);
  ffi.Pointer<
          ffi
          .NativeFunction<ffi.Void Function(ffi.Pointer<llama_kv_cache_view>)>>
      get llama_kv_cache_view_free =>
          ffi.Native.addressOf(self.llama_kv_cache_view_free);
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(llama_batch)>>
      get llama_batch_free => ffi.Native.addressOf(self.llama_batch_free);
  ffi.Pointer<ffi.NativeFunction<ffi.Void Function(ffi.Pointer<llama_sampler>)>>
      get llama_sampler_free => ffi.Native.addressOf(self.llama_sampler_free);
}
...
enum VocabType {
  ...
  final int value;
  const VocabType(this.value);

  static VocabType fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for VocabType: $value"),
      };
}
...
enum VocabPreType {
  ...
  final int value;
  const VocabPreType(this.value);

  static VocabPreType fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for VocabPreType: $value"),
      };
}
...
enum RopeType {
  ...
  final int value;
  const RopeType(this.value);

  static RopeType fromValue(int value) => switch (value) {
        -1 => LLAMA_ROPE_TYPE_NONE,
        0 => LLAMA_ROPE_TYPE_NORM,
        2 => LLAMA_ROPE_TYPE_NEOX,
        8 => LLAMA_ROPE_TYPE_MROPE,
        24 => LLAMA_ROPE_TYPE_VISION,
        _ => throw ArgumentError("Unknown value for RopeType: $value"),
      };
}
...
enum TokenType {
  ...
  static TokenType fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for TokenType: $value"),
      };
}
...
enum TokenAttr {
  ...
  final int value;
  const TokenAttr(this.value);

  static TokenAttr fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for TokenAttr: $value"),
      };
}
...
enum FileType {
  ...
  static FileType fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for FileType: $value"),
      };
}
...
enum RopeScalingType {
  ...
  final int value;
  const RopeScalingType(this.value);

  static RopeScalingType fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for RopeScalingType: $value"),
      };

  @override
  String toString() {
    if (this == LLAMA_ROPE_SCALING_TYPE_LONGROPE)
      return "RopeScalingType.LLAMA_ROPE_SCALING_TYPE_LONGROPE, RopeScalingType.LLAMA_ROPE_SCALING_TYPE_MAX_VALUE";
...
enum PoolingType {
  ...
  static PoolingType fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for PoolingType: $value"),
      };
}
...
enum AttentionType {
  ...
  final int value;
  const AttentionType(this.value);

  static AttentionType fromValue(int value) => switch (value) {
        -1 => LLAMA_ATTENTION_TYPE_UNSPECIFIED,
        0 => LLAMA_ATTENTION_TYPE_CAUSAL,
        1 => LLAMA_ATTENTION_TYPE_NON_CAUSAL,
        _ => throw ArgumentError("Unknown value for AttentionType: $value"),
      };
}
...
enum SplitMode {
  ...
  final int value;
  const SplitMode(this.value);

  static SplitMode fromValue(int value) => switch (value) {
        0 => LLAMA_SPLIT_MODE_NONE,
        1 => LLAMA_SPLIT_MODE_LAYER,
        2 => LLAMA_SPLIT_MODE_ROW,
        _ => throw ArgumentError("Unknown value for SplitMode: $value"),
      };
}
...
enum ModelKvOverrideType {
  ...
  final int value;
  const ModelKvOverrideType(this.value);

  static ModelKvOverrideType fromValue(int value) => switch (value) {
        0 => LLAMA_KV_OVERRIDE_TYPE_INT,
        1 => LLAMA_KV_OVERRIDE_TYPE_FLOAT,
        2 => LLAMA_KV_OVERRIDE_TYPE_BOOL,
        3 => LLAMA_KV_OVERRIDE_TYPE_STR,
        _ =>
          throw ArgumentError("Unknown value for ModelKvOverrideType: $value"),
      };
}
...
final class llama_model_kv_override extends ffi.Struct {
  ...
  ModelKvOverrideType get tag => ModelKvOverrideType.fromValue(tagAsInt);
...
final class llama_model_params extends ffi.Struct {
  ...
  SplitMode get split_mode => SplitMode.fromValue(split_modeAsInt);
...
enum GGMLType {
  ...
  static GGMLType fromValue(int value) => switch (value) {
        0 => GGML_TYPE_F32,
        1 => GGML_TYPE_F16,
        2 => GGML_TYPE_Q4_0,
        3 => GGML_TYPE_Q4_1,
        ...
        35 => GGML_TYPE_TQ2_0,
        39 => GGML_TYPE_COUNT,
        _ => throw ArgumentError("Unknown value for GGMLType: $value"),
      };
}
...
enum GGMOp {
  ...
  final int value;
  const GGMOp(this.value);

  static GGMOp fromValue(int value) => switch (value) {
        0 => GGML_OP_NONE,
        1 => GGML_OP_DUP,
        2 => GGML_OP_ADD,
        3 => GGML_OP_ADD1,
        ...
        83 => GGML_OP_COUNT,
        _ => throw ArgumentError("Unknown value for GGMOp: $value"),
      };
}
...
final class ggml_tensor extends ffi.Struct {
  ...
  GGMLType get type => GGMLType.fromValue(typeAsInt);
  ...
  GGMOp get op => GGMOp.fromValue(opAsInt);
...
final class llama_context_params extends ffi.Struct {
  ...
  RopeScalingType get rope_scaling_type =>
      RopeScalingType.fromValue(rope_scaling_typeAsInt);

  /// whether to pool (sum) embedding results by sequence id
  @ffi.Int()
  external int pooling_typeAsInt;

  PoolingType get pooling_type => PoolingType.fromValue(pooling_typeAsInt);

  /// attention type to use for embeddings
  @ffi.Int()
  external int attention_typeAsInt;

  AttentionType get attention_type =>
      AttentionType.fromValue(attention_typeAsInt);
  ...
  GGMLType get type_k => GGMLType.fromValue(type_kAsInt);

  /// data type for V cache [EXPERIMENTAL]
  @ffi.UnsignedInt()
  external int type_vAsInt;

  GGMLType get type_v => GGMLType.fromValue(type_vAsInt);
...
final class llama_model_quantize_params extends ffi.Struct {
  ...
  FileType get ftype => FileType.fromValue(ftypeAsInt);

  /// output tensor type
  @ffi.UnsignedInt()
  external int output_tensor_typeAsInt;

  GGMLType get output_tensor_type =>
      GGMLType.fromValue(output_tensor_typeAsInt);

  /// token embeddings tensor type
  @ffi.UnsignedInt()
  external int token_embedding_typeAsInt;

  GGMLType get token_embedding_type =>
      GGMLType.fromValue(token_embedding_typeAsInt);
...
enum GGMLNumaStrategy {
  ...
  final int value;
  const GGMLNumaStrategy(this.value);

  static GGMLNumaStrategy fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for GGMLNumaStrategy: $value"),
      };
}
...
enum GGMLLogLevel {
  ...
  final int value;
  const GGMLLogLevel(this.value);

  static GGMLLogLevel fromValue(int value) => switch (value) {
        ...
        _ => throw ArgumentError("Unknown value for GGMLLogLevel: $value"),
      };
}
...
typedef Dartggml_log_callbackFunction = void Function(GGMLLogLevel level,
    ffi.Pointer<ffi.Char> text, ffi.Pointer<ffi.Void> user_data);
